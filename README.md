...
This collection will soon be renamed from dandyrow.linux to dandyrow.linux to better reflect the contents of it.

This will require an update to anywhere this collection is used from dandyrow.linux to dandyrow.linux.

This collection contains roles and modules to install, configure and interact with various software on linux.
